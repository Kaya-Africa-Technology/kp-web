...
function KayaCapital() {
  return (
    <section className='container px-4 mx-auto my-16 transition-all duration-500 ease-in-out lg:py-20 lg:my-36'>
      <div className="grid grid-cols-1 gap-y-10 lg:grid-cols-2 lg:gap-y-0 lg:gap-x-10">
        ...
        <div className="w-full lg:place-self-end">
          <div className="mb-0">
              <Image src='/kapita.jpeg' width={580} height={288} alt='decorative image' />
          </div>
        </div>
